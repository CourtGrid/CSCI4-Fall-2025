...
#Wait, I think I understand how this works. I THINK it starts counting at 0, but the computer is just treating the ‘0’ like we would a 1, so once it gets up to 9 the computer has counted 10 integers. I’m going to test stuff out. 
...
#Saw the part under lists about sorting, and saw that they had a bit of a tutorial so I figured I would try it out. I found that when I want to sort out a list numerically, all I have to do is type out list.sort(). This is (I’m pretty sure) just because there aren’t any specifications that I added in, so it automatically lists it numerically. I don’t know if it does the same alphabetically. I’m going to test that.
